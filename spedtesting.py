...
def speed_test(a, b, c):
    ...
    #######Label1_____________________________________
    ...
    #######Label2__________________________
    ...
    ####Label3__________________________________
    ...
    ########Label4_____________________________
    ...
    #######Label5____________________________________________
    ...
    # button
    Button2 = Button(root, text="Run Speed Test", bg='sky blue', font="arial 18 bold", bd=0, activebackground='white',
                     cursor='cross', command=check)
    Button2.place(x=85, y=560)

    #########label7___________________________________________________________
    Label1 = Label(root, text='Power by - ', font="arial 12 bold ", bg="white")
    Label1.place(x=70, y=620)
    Label2 = Label(root, text='babushubhamsingh ', font="arial 13 bold ", bg="white", fg='red')
